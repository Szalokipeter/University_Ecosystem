...
Route::middleware('auth:sanctum')->group(function(){
    Route::apiResource('personalCalendar/{id}', CalendarController::class); // ez a route minden tag számára elérhető (controller ellenőrzi hogy saját maga vagy admin)
    Route::apiResource('personalTodos/{id}', TodoController::class); // ez a route minden tag számára elérhető (controller ellenőrzi hogy saját maga vagy admin)
